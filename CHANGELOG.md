...
## 2026-09-14 — Μονό χρονικό χτύπημα σε δηλωμένο σπαστό

- Μονό χτύπημα μέσα σε δηλωμένο τμήμα διατηρεί το σπαστό ως `Σ`.
- Χτύπημα πριν από το πρώτο τμήμα μετακινεί μόνο το πρώτο μέρος, διατηρώντας
  τη διάρκειά του. Χτύπημα ανάμεσα στα μέρη ανακατασκευάζει το πρώτο προς τα
  πίσω.
- Κενό μικρότερο των τριών ωρών μετακινεί μόνο την έναρξη του δεύτερου μέρους,
  με τη δηλωμένη λήξη του σταθερή.
- Οι περιπτώσεις αυτές δεν οδηγούνται σε `Έλεγχο` και δεν υπολογίζουν πρόσθετο
  χρόνο από το εξωτερικό άνοιγμα του σπαστού.
