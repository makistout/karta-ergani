...
## 2026-08-19 — Απολογιστικός: στήλη «Χτύπημα» δείχνει όλα τα πραγματικά χτυπήματα

- Τα χτυπήματα που μεταφέρονται λογιστικά στην προηγούμενη ημέρα (overnight carry) εμφανίζονται πλέον και στη στήλη «Χτύπημα» της ημέρας που πραγματικά συνέβησαν.
- Αλλαγή μόνο στην εμφάνιση (`punch_recorded`, `punch_count`, explanation) — κανένας υπολογισμός δεν επηρεάζεται.
