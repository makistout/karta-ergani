...
## 2026-08-21 — Απολογιστικό: απόρριψη Ε/Μ σε Σ* και αυτόματη ανταλλαγή

- Το μεμονωμένο κλικ στο **Ε**, όταν υπάρχουν επιλογές ανταλλαγής, εφαρμόζει
  αυτόματα την πρώτη διαθέσιμη χρονολογικά, όπως η «Έγκριση όλων προς μεταβολή»,
  και δημιουργεί τις δύο συνδεδεμένες μεταβολές **Μ***.
