...
- Οι εντολές αποθηκεύονται αποκλειστικά ως draft/needs-clarification και η απάντηση
  περιγράφει τι **θα** εκτελεστεί. Καμία ενέργεια δεν αποστέλλεται στο ΕΡΓΑΝΗ.
