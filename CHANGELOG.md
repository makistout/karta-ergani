...
## 2026-08-19 — Ωρομέτρηση απολογιστικού
...
- Το ετήσιο υπόλοιπο υπερωρίας φορτώνεται μαζικά από το `karta_portal_schedule_archive` έως την προηγούμενη ημέρα της εβδομάδας, χωρίς query ανά εργαζόμενο.
- Στο εβδομαδιαίο `/ui/apologistic` εμφανίζεται κουμπί **Ωρομέτρηση** μόνο όταν δεν υπάρχουν εγγραφές Ελέγχου και ανοίγει τη χωριστή σελίδα `/ui/apologistic/timekeeping`.
