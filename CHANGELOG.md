...
## 2026-09-09 — Μερική απασχόληση εντός ευέλικτης προσέλευσης

- Η θετική ευέλικτη προσέλευση εφαρμόζεται πλέον πριν από τη μεταβολή λόγω
  μεγαλύτερης πραγματικής διάρκειας στη μερική απασχόληση.
- Όταν είσοδος και έξοδος παραμένουν μέσα στο αντίστοιχο παράθυρο ευελιξίας,
  διατηρείται το δηλωμένο ωράριο και η εγγραφή χαρακτηρίζεται `Σ`.
- Έξοδος πέρα από το τέλος του παραθύρου συνεχίζει να παράγει `Μ` με τον
  υπάρχοντα συμβατικό κόφτη.
- Νέα έκδοση απολογιστικού: `2026-09-09.rules-v14-partial-flex`.
