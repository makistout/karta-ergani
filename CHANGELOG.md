...
- Σε πολλαπλές **ετεροχρονισμένες** υποβολές κάρτας (AI agent, UI, auto-close) η
  ώρα χτυπήματος (`event_at`) αποστέλλεται με διαφορά 1–2 λεπτά ανά χτύπημα.
- 1ο στην ρητή ώρα, κάθε επόμενο +1–2 λεπτά. **Live/τώρα:** ίδια ώρα «τώρα»
  σε όλα — χωρίς stagger.
