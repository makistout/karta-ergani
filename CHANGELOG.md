...
- Νέα έκδοση υπολογισμού `timekeeping-v8-leave-normalization`.
- Το εμφανιζόμενο αναγνωρισμένο ωράριο διατηρεί ολόκληρη τη χρονική βάση των
  κανόνων δηλωμένου/χτυπήματος/ευελιξίας και την επέκταση εξωτερικού
  διαλείμματος. Ο ημερήσιος κόφτης περιορίζει μόνο τα καθαρά λεπτά κοινής βάσης.
