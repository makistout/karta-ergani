...
UI_PERMISSIONS: dict[str, str] = {
    ...
    "/ui/employees/hire": "employees.view",
...
API_RULES: tuple[RouteRule, ...] = (
    ...
    RouteRule("GET", "/api/employees/contract/change/*", "employees.view"),
    RouteRule("POST", "/api/employees/contract/change", "employees.sync"),
    ...
    RouteRule("POST", "/api/wto-daily-a/submit", "schedule.submit_daily"),
    RouteRule("POST", "/api/wto-ov-a/submit", "schedule.submit_daily"),
    ...
    RouteRule("POST", "/api/users/*/resend-verification-email", "users.edit"),
    RouteRule("PUT", "/api/users/*/permissions", "users.manage_permissions"),
    RouteRule("PUT", "/api/users/*/stores", "users.manage_store_access"),
    RouteRule("GET", "/api/users/*/activity", "users.view"),
    RouteRule("DELETE", "/api/users/*", "users.delete"),
    RouteRule("GET", "/api/users/*", "users.view"),
