...
- **Validation / εκτέλεση κάρτας**: ίδιοι κανόνες με Αρχική / `work_card_guards.py`
  ...
  - `sync_employees` (συγχρονισμός προσωπικού/Μητρώου): με πολλά καταστήματα
    **πάντα** `store_choice` (αγνοεί sticky τελευταίας ειδοποίησης)· με ένα μόνο
    αυτόματα· ρητό όνομα καταστήματος στο μήνυμα παρακάμπτει τη λίστα·
