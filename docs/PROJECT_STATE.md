...
- **Validation / εκτέλεση κάρτας**: ίδιοι κανόνες με Αρχική / `work_card_guards.py`
  ...
  - απλά `today_info` και απλά άνοιγμα/κλείσιμο κάρτας → κανόνες **πριν** από LLM·
    κοινό wall `ASSISTANT_LLM_WALL_SEC` (8s) ώστε να μην στοιβάζονται Gemini+OpenAI·
    OpenAI μόνο αν μένει χρόνος·
