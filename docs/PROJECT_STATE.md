...
- Η έκδοση `timekeeping-v6-break-basis` διαχωρίζει βάση, υπερεργασία 20%, πρόσθετη μερικής 12%, υπερωρίες 40%/60%/120% και 6η ημέρα 30% σε Ημέρας, Νύχτας, Κυριακής/Αργίας και Νύχτας/Κυριακής-Αργίας, πάνω στα πραγματικά λεπτά της κάθε κατηγορίας.
