...
- **Validation / εκτέλεση κάρτας**: ίδιοι κανόνες με Αρχική / `work_card_guards.py`
  ...
  - σαφείς εντολές κάρτας με επιλυμένο εργαζόμενο → deterministic fast path πριν από LLM·
  - τα υπόλοιπα ερωτήματα → Gemini, μετά OpenAI· τοπικοί κανόνες (`today_info`, κάρτα,
    «ποιος τελειώνει…») χρησιμοποιούνται και ως τελευταίο fallback·
