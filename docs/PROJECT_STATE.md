...
- Μετά από επιτυχές sync ωραρίου, αν εντοπιστούν ΑΦΜ χωρίς σύνδεση/QR, γίνεται
  background `opportunistic_employment_enrichment` (Μητρώο + QR) ώστε νέοι εργαζόμενοι
  να είναι άμεσα διαθέσιμοι στον scanner· το πλήρες ημερήσιο Μητρώο παραμένει στις ~04:00.
