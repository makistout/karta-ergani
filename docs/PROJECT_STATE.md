...
- Η έκδοση `timekeeping-v4-exclusive-base` διαχωρίζει βάση, υπερεργασία 20%, πρόσθετη μερικής 12%, μερική 120%, υπερωρίες 40%/60%/120% και 6η ημέρα 30% σε Ημέρας, Νύχτας, Κυριακής/Αργίας και Νύχτας/Κυριακής-Αργίας, πάνω στα πραγματικά λεπτά της κάθε κατηγορίας.
- Η κοινή βάση, η 6η ημέρα, η πρόσθετη μερικής 12% και η μερική 120% είναι αμοιβαία αποκλειόμενες και ελέγχεται ανά ημέρα ότι το άθροισμά τους ισούται με την καθαρή αναγνωρισμένη βάση. Στην εκ περιτροπής, οι επιπλέον αναγνωρισμένες ημέρες επιλέγονται Κυριακή→Δευτέρα και μπορεί να είναι περισσότερες από μία.
