...
- Η έκδοση `timekeeping-v8-leave-normalization` διαχωρίζει βάση, υπερεργασία 20%, πρόσθετη μερικής 12%, υπερωρίες 40%/60%/120% και 6η ημέρα 30% σε Ημέρας, Νύχτας, Κυριακής/Αργίας και Νύχτας/Κυριακής-Αργίας, πάνω στα πραγματικά λεπτά της κάθε κατηγορίας. Στην πλήρη απασχόληση η κοινή βάση κόβεται στην επιλεγμένη ημερήσια βάση ακόμη και όταν λανθασμένη δήλωση 9+ ωρών ταυτίζεται με το χτύπημα, ενώ οι προσαυξήσεις του πραγματικού μη πρόσθετου τμήματος διατηρούνται ως κατώτατο όριο. Οι περιγραφές άδειας αναγνωρίζονται ανεξάρτητα από ελληνικούς τόνους και εξαιρούνται από την ωρομέτρηση.
