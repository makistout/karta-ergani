...
- `accountant` (λογιστής): λειτουργικές οθόνες (ωράριο, πραγματική, απολογιστικό, κάρτα,
  εργαζόμενοι, ελλειπή) χωρίς Συγχρονισμό/Καταστήματα/Καταγραφές/Χρήστες· στις Ρυθμίσεις
  μόνο Αργίες. Έχει `schedule.submit_daily` ώστε να υποβάλλει μαζικά μεταβολές
  απολογιστικού στο Ergani (WTODailyA / WTOOvA).
