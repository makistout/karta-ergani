...
- Μόνο `super_admin` βλέπει την ένδειξη υγείας Telegram assistant κάτω από το
...
- `accountant` (λογιστής): λειτουργικές οθόνες (ωράριο, πραγματική, απολογιστικό, κάρτα,
  εργαζόμενοι, ελλειπή, **Καταστήματα για επιλογή**) χωρίς Συγχρονισμό/Καταγραφές/Χρήστες·
  στις Ρυθμίσεις Αργίες και ενότητα Απολογιστικό (ΡΕΠΟ Κυριακής / ανισομερής). Έχει
  `schedule.submit_daily` ώστε να υποβάλλει μαζικά μεταβολές απολογιστικού στο Ergani
