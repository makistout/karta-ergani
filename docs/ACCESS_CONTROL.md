...
- `accountant` (λογιστής): λειτουργικές οθόνες (ωράριο, πραγματική, απολογιστικό, κάρτα,
  ...
  στις Ρυθμίσεις μόνο Αργίες. Έχει `schedule.submit_daily` ώστε να υποβάλλει μαζικά μεταβολές
  απολογιστικού στο Ergani (WTODailyA / WTOOvA). Δεν διαχειρίζεται credentials/νέα καταστήματα.
