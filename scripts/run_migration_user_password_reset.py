"""Εφαρμογή sql/alter_add_user_password_reset.sql (idempotent)."""
...
sql_path = ROOT / "sql" / "alter_add_user_password_reset.sql"
...
row = cur.fetchone()
print(
    "OK: password reset columns exist"
    if row and row[0] is not None
    else "MISSING: password reset columns"
)
cur.close()
conn.close()
